...
expect(nav.includes("{ label: 'Tasks', path: '/tasks'"), 'Tasks must remain directly reachable from primary navigation.');
expect(!navState.includes("pathname === '/tasks'"), 'Tasks must keep its own primary navigation context instead of inheriting Home.');
